...
class metrolink_watchView extends WatchUi.View {
    ...
    function initialize(routes as Array<Route>) {
        self.routes = routes;
        self.textArea = new ScrollArea({:identifier=>"routeInfo", :width=>240, :text=>"", :justification=>Graphics.TEXT_JUSTIFY_CENTER, :height=>240, :font=>[Graphics.FONT_MEDIUM] as Array<Graphics.FontType>});
        View.initialize();
    }
